...
Email: &nbsp;&nbs;p&nbsp;&nbsp;&nbsp;&nbsp; <input type="email"name="Email" width="300"height="300"required><br><br>
UserName:<input type="text"name="UserName" width="300"height="300"><br><br>
Password:&nbsp;&nbsp;<input type="password"name="Password" width="300"height="300"required><br>
<button type="submit" name="signup">SignUp</button>
   <p> Alreadry have account?  <a href="loginForm.php">Log in</a> </p>
</form>
</body>
</html>
